  ...
  return (
    <>
      <div className="w-full border-y-2 border-black">
        <motion.div className="grid grid-cols-2 sm:grid-cols-4">
          {prods.data?.products?.edges?.length > 0 && (
            <CardHome
              index={prods.data.products.edges[0].node.id}
              img={prods.data.products.edges[0].node.images.edges[1].node.url}
          ...
          {prods.data?.products?.edges?.length > 0 && (
            <CardHome
              ...
              img={prods.data.products.edges[1].node.images.edges[1].node.url}
          ...
          {prods.data?.products?.edges?.length > 0 && (
            <CardHome
              ...
              img={prods.data.products.edges[2].node.images.edges[1].node.url}
          ...
          {prods.data?.products?.edges?.length > 0 && (
            <CardHome
              ...
              img={prods.data.products.edges[3].node.images.edges[1].node.url}
