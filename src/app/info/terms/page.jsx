  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="mt-32 px-20 w-full flex flex-col pt-10 pb-32 gap-6 text-xl">
        ...
        <h3 className="font-extrabold mt-10 text-xl">OVERVIEW</h3>
        <h2 className="text-xl font-bold">
          This website is operated by Retrova. Throughout the site, the terms
          “we”, “us” and “our” refer to Retrova. Retrova offers this website,
        ...
        <p>
          ...
          bebound by these Terms of Service. If you do not agree to all the
        ...
        <p>
          ...
          of Serviceby posting updates and/or changes to our website. It is your
        ...
        <h3 className="font-extrabold mt-10 text-xl">ONLINE STORE TERMS</h3>
        <p>
        ...
        <h3 className="font-extrabold mt-10 text-xl">GENERAL CONDITIONS</h3>
        <p>
        ...
        <p>
          ...
          Credit card informationis always encrypted during transfer over
          networks.
        </p>
        <p>
        ...
        <h3 className="font-extrabold mt-10 text-xl">
        ...
        <p>
          ...
          perhousehold or per order. These restrictions may include orders
        ...
        <h3 className="font-extrabold mt-10 text-xl">OPTIONAL TOOLS</h3>
        <p>
        ...
        <h3 className="font-extrabold mt-10 text-xl">- THIRD-PARTY LINKS</h3>
        <p>
        ...
        <p>
          ...
          website. Youmay not use a false e-mail address, pretend to be someone
          other than yourself, or otherwise mislead us or third-parties as to
          the origin of anycomments. You are solely responsible for any comments
        ...
        <h3 className="font-extrabold mt-10 text-xl">PERSONAL INFORMATION</h3>
        <p>
        ...
        <p>
          ...
          or on anyrelated website is inaccurate at any time without prior
        ...
        <h3 className="font-extrabold mt-10 text-xl">PROHIBITED USES</h3>
        <p>
        ...
        <p>
          ...
          Retrova, our directors, officers, employees, affiliates, agents,
        ...
        <h3 className="font-extrabold mt-10 text-xl">INDEMNIFICATION</h3>
        <p>
          You agree to indemnify, defend and hold harmless Retrova and our
        ...
        <h3 className="font-extrabold mt-10 text-xl">SEVERABILITY</h3>
        <p>
          In the event that any provision of these Terms of Service is
          determined to be unlawful, void or unenforceable, such provision shall
          nonethelessbe enforceable to the fullest extent permitted by
          applicable law, and the unenforceable portion shall be deemed to be
          severed from these Terms of Service, such determination shall not
          affect the validity and enforceability of any other remaining
          provisions.
        </p>
        <h3 className="font-extrabold mt-10 text-xl">TERMINATION</h3>{" "}
        <p>
        ...
        <h3 className="font-extrabold mt-10 text-xl">- ENTIRE AGREEMENT</h3>
        <p>
        ...
        <h3 className="font-extrabold mt-10 text-xl">GOVERNING LAW</h3>
        <p>
